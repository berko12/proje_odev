    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "dbdeneme");
        ...
        public static void Setup()
        {
            ...
            try
            {
                ...
                var mapping = GetMappings();
                NhConfiguration.AddDeserializedMapping(mapping, "dbdeneme");
        ...
        {
            //log.Warn("Check DB");
            if (System.IO.File.Exists(exctLcl + "\\dbdeneme.db")) return;
            SQLiteConnection.CreateFile(exctLcl + "\\dbdeneme.db");
            using (var cn = new SQLiteConnection("Data Source=" + exctLcl + "\\dbdeneme.db;Version=3;Password=;PRAGMA journal_mode=WAL;"))
            {
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=" + exctLcl + "//dbdeneme.db;Version=3;PRAGMA journal_mode=WAL;";
            });
